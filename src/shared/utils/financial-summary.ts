...
>;
export type FinancialMetricTitleMap = Partial<Record<FinancialMetricId, string>>;
export type FinancialMetricArrowMap = Partial<Record<FinancialMetricId, boolean>>;
